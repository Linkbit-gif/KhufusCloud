mw.loader.implement("jquery@ygxv7", function($, jQuery, require, module) {
    (function(global, factory) {
        "use strict";
        if (typeof module === "object" && typeof module.exports === "object") {
            module.exports = global.document ? factory(global, !1) : function(w) {
                if (!w.document) {
        ...
        var isFunction = function isFunction(obj) {
            return typeof obj === "function" && typeof obj.nodeType !== "1" && typeof obj.item !== "function";
        };
    ...
    (function(factory) {
        ...
        var findProp, class2type = {}, oldInit = jQuery.fn.init, oldFind = jQuery.find, rattrHashTest = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/, rattrHashGlob = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/g, rtrim = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;
        ...
        migrateWarnProp(jQuery.expr, "filters", jQuery.expr.pseudos, "jQuery.expr.filters is deprecated; use jQuery.expr.pseudos", "expr_filters");
        migrateWarnProp(jQuery.expr, ":", jQuery.expr.pseudos, "jQuery.expr[':'] is deprecated; use jQuery.expr.pseudos", "expr_colon");
        ...
        if (jQuery.ajax) {
            ...
            jQuery.ajax = function() {
                ...
                if (jQXHR.promise) {
                    migrateWarnFunc(jQXHR, "success", jQXHR.done, "jQXHR.success is deprecated and removed", "jQXHR_success");
                    migrateWarnFunc(jQXHR, "error", jQXHR.fail, "jQXHR.error is deprecated and removed", "jQXHR_error");
                    migrateWarnFunc(jQXHR, "complete", jQXHR.always, "jQXHR.complete is deprecated and removed", "jQXHR_complete");
                }
                return jQXHR;
            }
            ;
        ...
        var oldFnCss, internalSwapCall = !1, ralphaStart = /^[a-z]/, rautoPx = /^(?:Border(?:Top|Right|Bottom|Left)?(?:Width|)|(?:Margin|Padding)?(?:Top|Right|Bottom|Left)?|(?:Min|Max)?(?:Width|Height))$/;
        if (jQuery.swap) {
        ...
        ;
        if (jQuery.fx) {
            var intervalValue, intervalMsg, oldTweenRun = jQuery.Tween.prototype.run, linearEasing = function(pct) {
                return pct;
            };
        ...
        migrateWarnProp(jQuery.event.props, "concat", jQuery.event.props.concat, "jQuery.event.props.concat is deprecated and removed", "events_props");
